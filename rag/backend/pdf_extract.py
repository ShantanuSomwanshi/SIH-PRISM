...
#
#     αñ¡αñ╛αñ░αññαÑÇαñ» αñ«αñ╛αñ¿αñò   ->   Hkkjrh; ekud
#
...
#       8 of them clean English mix-design pages full of = x + - Γëê
...
#       (where ├ÿ means diameter, not a Devanagari glyph)
#
...
def has_devanagari(text: str) -> bool:
    ...
    return any("αñÇ" <= c <= "αÑ┐" for c in text or "")
