...
# regularly returns it as "15" - "αñ¡αñ╛αñ░αññαÑÇαñ» αñ«αñ╛αñ¿αñò IS 10262 : 2019" comes back
# as "αñ¡αñ╛αñ░αññαÑÇαñ» αñ╕αñ╛αñ¿αñò 15 10262 : 2019".
#
...
# codepoints, so "αñ¡αñ╛αñ░αññαÑÇαñ» αñ«αñ╛αñ¿αñò" extracts as "Hkkjrh; ekud" and the Hindi
# title as "oaQ├ÿhV feJ vuqikru". Those are Latin characters, so a script
...
# punctuation, and the degree sign is real ("25 ┬░C"). ├ÿ is a diameter mark
# on engineering DRAWINGS, but a title is not a drawing.
LEGACY_TITLE_GLYPHS = set("┬╝┬╜┬╛├ÿ├░├╛├╜├₧┬í┬┐┬¬┬║┬º┬╢ΓÇáΓÇí")
